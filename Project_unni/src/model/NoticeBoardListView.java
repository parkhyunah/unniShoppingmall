...
public class NoticeBoardListView {
...
private List<NoticeBoard> boardList; //화면에 표시할 게시글 리스트 파라미터

public NoticeBoardListView(int currentPageNumber, int boardCountPerPage, int boardTotalCount, List<NoticeBoard> boardList) {
...
public void setBoardList(List<NoticeBoard> boardList) {
    this.boardList = boardList;
}
}