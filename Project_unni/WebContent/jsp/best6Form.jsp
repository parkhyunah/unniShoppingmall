	...
	<div id="navi"><jsp:include page="outline.jsp" /></div>
	 <div id = "wrap">
        <div id="section" align="center">
    	 <br>
    	  <h1 style="font-family: 'Sriracha', cursive;">Best 6</h1>
      <table class="imgTable"><br>
         <tr>
            ...
            <c:if test="${status.index%3==0}">
               ...
               <div class="imgTopic">
               		...
               		<span class="itemAtt">${item.itemName }<br>${item.itemPrice } won</span>
               	</a></div></td>
            </c:forEach>
         </tr>
      </table>
